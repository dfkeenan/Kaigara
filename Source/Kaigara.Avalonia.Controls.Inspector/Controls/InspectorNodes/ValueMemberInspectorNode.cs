    ...
    where T : struct
{
    ...
    public ValueMemberInspectorNode(InspectorContext context, InspectorNodeProvider provider, ObjectInspectorNode parent, MemberInfo memberInfo, object[] index = null)
